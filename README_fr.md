...
> [!WARNING]
> **Aperçu de la nouvelle version majeure :** cette version n'a pas encore été suffisamment validée en conditions réelles. Certaines fonctionnalités peuvent ne pas fonctionner correctement, mais vous pouvez tout de même l'essayer et signaler les problèmes rencontrés.
>
> Le site Kemono n'étant plus disponible, KToolBox utilise désormais par défaut son site miroir Pawchive.
>
> Consultez les [notes de version v1.0.0](https://github.com/Ljzd-PRO/KToolBox/releases/tag/v1.0.0) et le [guide de migration du site de documentation](https://ktoolbox.readthedocs.io/latest/fr/migration-v1/) avant la mise à niveau.

**Documentation :** [Bien démarrer](https://ktoolbox.readthedocs.io/latest/fr/) · [CLI](https://ktoolbox.readthedocs.io/latest/fr/commands/guide/) · [WebUI](https://ktoolbox.readthedocs.io/latest/fr/webui/) · [Migration](https://ktoolbox.readthedocs.io/latest/fr/migration-v1/) · [Dépannage](https://ktoolbox.readthedocs.io/latest/fr/faq/)
...
Le nommage et l’emplacement de téléchargement par défaut appartiennent au projet. La page **Format de nommage** enregistre séparément la structure et les modèles ; les chemins relatifs sont résolus depuis le projet et les chemins absolus externes sont acceptés. Le convertisseur réutilisable accepte plusieurs versions de l’historique ou une ancienne configuration `.env`/TOML dans un éditeur avec coloration. Le projet actuel reste toujours la cible en lecture seule, le texte collé n’est pas conservé, et les déplacements prennent en charge pause, reprise et restauration. Si d’anciennes clés dotenv sont détectées, la WebUI demande confirmation avant la migration sauvegardée et n’analyse jamais automatiquement les répertoires. Consultez le [guide du nommage](https://ktoolbox.readthedocs.io/latest/fr/naming/).
