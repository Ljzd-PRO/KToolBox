...
> [!WARNING]
> **Предварительная версия нового крупного выпуска:** эта версия ещё не прошла достаточную проверку в реальных условиях. Некоторые функции могут работать неправильно, однако вы можете попробовать её и сообщить о найденных проблемах.
>
