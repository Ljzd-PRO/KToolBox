...
- Управление одним проектом синхронизации через адаптивную панель HeroUI на английском и упрощённом китайском языках: постоянные задачи, ход выполнения в реальном времени, формы конфигурации, редакторы списка авторов и правил исключения, светлая и тёмная темы.
