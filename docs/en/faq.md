...
No. Project Schema v5 requires every internal path to be a safe, non-empty relative name. Use **Naming format** to choose an attachment subdirectory; this prevents attachments from colliding with the primary file or metadata.
