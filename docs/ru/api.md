...
!!! note
    Эта страница предназначена для разработчиков приложений. Чтобы загружать и синхронизировать без программирования, используйте [WebUI](webui.md), а для клиентов ИИ — [MCP](mcp.md).
...
- В разделе [О Pawchive](about-pawchive.md) описаны область backend и границы конфиденциальности.
- Для аутентифицированного доступа к инструментам через WebUI используйте [руководство MCP](mcp.md).
- Пользовательские сценарии описаны в [руководстве по командам](commands/guide.md).
