...
Подробности показывают подготовленных авторов, файлы, байты, общий прогресс, общую и файловую скорость, ETA, числа пропусков/ошибок, активных авторов, активные загрузки, ожидающие повтора файлы и структурированные журналы. Три панели реального времени имеют постоянную высоту и отдельную прокрутку, поэтому изменение параллельности не сдвигает журнал или страницу. Режим активности по умолчанию скрывает побайтовый прогресс и обычный шум очереди; при необходимости доступны режимы передач и полной диагностики.
