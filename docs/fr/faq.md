...
Non. Le Schema v5 exige un nom relatif sûr et non vide pour chaque chemin interne. Choisissez un sous-répertoire dans **Format de nommage** afin d'éviter les collisions avec le fichier principal ou les métadonnées.
