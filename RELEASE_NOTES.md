...
- Python 支持范围修正为 `>=3.10,<3.15`，覆盖完整 Python 3.10 至 3.14 系列，不再把 Python 3.14.1 以后版本错误排除。
...
- Correct Python metadata to support the complete Python 3.10 through 3.14 range.
