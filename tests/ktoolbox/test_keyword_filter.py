from ktoolbox.action.utils import filter_posts_by_keywords, match_post_keywords
...
class TestKeywordFiltering:
    ...
    def test_match_post_keywords_empty_keywords(self):
        ...
        result = match_post_keywords(post, set())
        assert result is True

        result = match_post_keywords(post, None)
        assert result is True
    ...
    def test_match_post_keywords_title_match(self):
        ...
        result = match_post_keywords(post, keywords)
        assert result is True
